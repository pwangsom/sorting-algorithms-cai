package com.sit.cai.sorting.view.data.three;
...
public class DataThreePanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public DataThreePanel() {
		setBackground(new Color(175, 238, 238));
		setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));
		setBounds(0, 0, Constants.DIM_W, Constants.DIM_H);	

		panelHead = new HeaderPanel(Constants.APP_NAME + " - " + "Data Three");
